...
ก่อนเปิดเว็บครั้งแรก ให้กำหนดรหัสตั้งค่าระบบด้วย `npx wrangler secret put BOOTSTRAP_TOKEN` แล้วกรอกรหัสนั้นในหน้า Setup พร้อมรหัสผ่านผู้ดูแลและรหัสผ่านเริ่มต้นของสาขา ซึ่งแต่ละรหัสผ่านต้องมีอย่างน้อย 4 ตัวอักษร. ไม่ควรส่งรหัสผ่านผ่านแชตหรือเก็บไว้ใน Git.
